...
\node[vertex] (9) at (2.427050983124842,-1.7633557568774196) [inner sep=0.1em,regular polygon,regular polygon sides=3] {\color{fontcolor}9};
...
\path[line width=4.0,bicolor_neg={col0}{col0}, bend right=0.0, opacity=1.0] (2) to (9);
...
\path[line width=4.0,bicolor_neg={col0}{col1}, bend right=0.0, opacity=1.0] (4) to (5);
