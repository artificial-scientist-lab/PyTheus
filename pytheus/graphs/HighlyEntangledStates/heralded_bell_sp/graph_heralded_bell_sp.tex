...
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=0.3] (2) to (6);
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=0.3] (2) to (7);
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=0.3] (3) to (6);
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=0.3] (3) to (7);
\path[line width=4.0,bicolor_neg={col0}{col0}, bend right=0.0, opacity=0.3] (4) to (6);
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=0.3] (4) to (7);
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=0.3] (5) to (6);
\path[line width=4.0,bicolor_neg={col0}{col0}, bend right=0.0, opacity=0.3] (5) to (7);
