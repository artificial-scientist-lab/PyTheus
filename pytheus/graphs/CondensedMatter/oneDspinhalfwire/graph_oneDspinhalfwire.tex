...
\path[line width=4.0,bicolor={col0}{col0}, bend right=-16.875, opacity=1.0] (1) to (2);
\path[line width=4.0,bicolor={col0}{col1}, bend right=-5.625, opacity=1.0] (1) to (2);
\path[line width=4.0,bicolor={col1}{col0}, bend right=5.625, opacity=1.0] (1) to (2);
\path[line width=4.0,bicolor={col1}{col1}, bend right=16.875, opacity=1.0] (1) to (2);
