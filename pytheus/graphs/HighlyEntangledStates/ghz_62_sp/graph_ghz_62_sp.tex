...
\path[line width=4.0,bicolor_neg={col0}{col1}, bend right=0.0, opacity=1.0] (0) to (10);
...
\path[line width=4.0,bicolor={col1}{col0}, bend right=0.0, opacity=1.0] (2) to (11);
\path[line width=4.0,bicolor_neg={col0}{col1}, bend right=0.0, opacity=1.0] (3) to (8);
\path[line width=4.0,bicolor_neg={col0}{col0}, bend right=0.0, opacity=1.0] (3) to (11);
...
\path[line width=4.0,bicolor={col1}{col0}, bend right=0.0, opacity=1.0] (5) to (9);
