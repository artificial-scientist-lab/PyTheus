...
\path[line width=4.0,bicolor_neg={col1}{col1}, bend right=11.25, opacity=1.0] (0) to (5);
...
\path[line width=4.0,bicolor={col1}{col1}, bend right=11.25, opacity=1.0] (1) to (4);
\path[line width=4.0,bicolor_neg={col1}{col0}, bend right=-11.25, opacity=1.0] (2) to (4);
\path[line width=4.0,bicolor={col1}{col1}, bend right=11.25, opacity=1.0] (2) to (4);
