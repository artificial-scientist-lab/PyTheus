...
\path[line width=4.0,bicolor={col0}{col1}, bend right=0.0, opacity=1.0] (0) to (5);
\path[line width=4.0,bicolor={col1}{col1}, bend right=0.0, opacity=1.0] (1) to (0);
...
\path[line width=4.0,bicolor={col1}{col1}, bend right=0.0, opacity=1.0] (2) to (5);
\path[line width=4.0,bicolor_neg={col1}{col1}, bend right=0.0, opacity=1.0] (3) to (4);
\path[line width=4.0,bicolor={col0}{col0}, bend right=0.0, opacity=1.0] (4) to (5);
\path[line width=4.0,bicolor_neg={col1}{col1}, bend right=0.0, opacity=1.0] (6) to (7);
...
\path[line width=4.0,bicolor_neg={col0}{col1}, bend right=0.0, opacity=1.0] (8) to (9);
